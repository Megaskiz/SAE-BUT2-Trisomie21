    ...
    for ($i = 0;$i < $nombre_ligne;$i++) { //affichage des objectifs
        ...
        if ($_SESSION["role_user"] == 1 || $double_tab[$i][4] == 1 or $_SESSION["role_user"] == 3) {
            ...
            echo "<p class='popup-txt'> Voulez-vous rendre à nouveau utilisable cet objectif ? Il sera visible par tous les membres suivant cet enfant et apparaîtra dans les statistiques.  </p>";
            ...
            echo "<p class='popup-txt'>Voulez-vous supprimer définitivement cet objectif ? Cela le retirera des statistiques, supprimera tous ses messages et toutes ses récompenses.  </p>";
            echo ' <div style="display:flex; justify-content: space-evenly;" >';
            echo '  <button class="popup-btn" type="button" onclick="closeDialog(this)">Annuler</button>';
