...
function create_nav_admin($linkpdo)
{ // fonction qui affiche le nav (partie de gauche) pour les utilisateurs avec  tous les privilèges
    echo '
            <nav  class="left-contenu">
                    <ul class="scrolling-tabs nav-links gl-display-flex gl-flex-grow-1 gl-w-full nav gl-tabs-nav nav gl-tabs-nav">
                    <li class="nav-item">
...
function create_nav_coordinateur($linkpdo)
{ // fonction qui affiche le nav (partie de gauche) pour les coordinateurs
    echo '
            <nav  class="left-contenu">
                    <ul class="scrolling-tabs nav-links gl-display-flex gl-flex-grow-1 gl-w-full nav gl-tabs-nav nav gl-tabs-nav">
                    <li class="nav-item">
