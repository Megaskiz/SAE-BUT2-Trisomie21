...
<body>
    ...
    <!---------------------------------------------------------------------- Header -------------------------------------------------------------->
    <header>
        <img class="img_header" src="img/logo_trisomie.png" alt="logo de l'assiciation">
        <img class="img_user" src="img/user_logo.png" alt="tete de l'utilisateur">
        ...
        echo "</table>";
        ?>
        <p class="grid_item"><a href="index_login.php">Déconnexion</a></p>
                ...
                <div>
                    ...
                    <div id="dialog_layer" class="dialogs">
                        <div role="dialog" id="dialog1" aria-labelledby="dialog1_label" aria-modal="true" class="hidden">
                            ...
                            <form action="page.php" method="post" class="dialog_form">
                ...
                <div>
                    ...
                    <div id="dialog_layer" class="dialogs">
                        <div role="dialog" id="dialog5" aria-labelledby="dialog1_label" aria-modal="true" class="hidden">
                            <form action="page_suppr.php" method="post" class="dialog_form">
        ...
        <div class="f-contenu">
            ...
            <div class="bloc footer-horaire">
                ...
                <ul class="liste-horaire">
                    ...
                    <li><a href="#">✕ Sam fermé</a></li>
                    <li><a href="#">✕ Dim fermé</a></li>
                </ul>
            </div>
